...
export function CookieLogin({ onSuccess, scope = 'cn' }: CookieLoginProps) {
    ...
    const cookieInstructions = scope === 'global' ? [
        ...
        '3. 切换到 "存储" (Firefox) 或 "Application" (Chrome) 标签',
        '4. 左侧点击 "Cookie" → "https://account.hoyoverse.com"',
        '5. 复制 cookie_token_v2 和 account_id 的值',
        '6. 粘贴格式: cookie_token_v2=xxx; account_id=yyy'
    ] : [
        '1. 在弹出的米游社窗口中完成登录',
        '2. 登录成功后，按 F12 打开开发者工具',
        '3. 切换到 "存储" (Firefox) 或 "应用程序" (Chrome) 标签',
        '4. 左侧点击 "Cookie" → "https://user.mihoyo.com"',
        '5. 找到 cookie_token_v2 和 account_id 这两个字段',
        '6. 粘贴格式: cookie_token_v2=值1; account_id=值2'
    ];
        ...
        <div className="space-y-4">
                ...
                <div className="space-y-3">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            placeholder="cookie_token_v2=v2_xxx...; account_id=123..."
                            rows={3}
            ...
            {step === 1 && (
                <div className="text-xs text-gray-500 space-y-1">
                    <p>• 使用官方登录页面，安全可靠</p>
                    <p>• 需要同时复制 cookie_token_v2 和 account_id</p>
                    <p>• Cookie 仅用于本次会话</p>
                </div>
            )}
        </div>
